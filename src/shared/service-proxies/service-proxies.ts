...
@Injectable()
export class AutorServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    create(body: CreateAutorDto | undefined): Observable<AutorDto> {
        let url_ = this.baseUrl + "/api/services/app/Autor/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<AutorDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = AutorDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
     ...
     * @return Success
     */
    update(body: UpdateAutorDto | undefined): Observable<AutorDto> {
        let url_ = this.baseUrl + "/api/services/app/Autor/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<AutorDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * @param idAutor (optional) 
     * @return Success
     */
    deActivate(idAutor: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Autor/DeActivate?";
        if (idAutor === null)
            throw new Error("The parameter 'idAutor' cannot be null.");
        else if (idAutor !== undefined)
            url_ += "idAutor=" + encodeURIComponent("" + idAutor) + "&";
        url_ = url_.replace(/[?&]$/, "");
    ...
    getAutores(keyword: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined, pageNumber: number | undefined, pageSize: number | undefined): Observable<AutorDtoPagedResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAutores(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
     ...
     * @return Success
     */
    getAutorById(id: number | undefined): Observable<AutorDto> {
        let url_ = this.baseUrl + "/api/services/app/Autor/GetAutorById?";
        if (id === null)
    ...
    protected processGetAutorById(response: HttpResponseBase): Observable<AutorDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<AutorDto> {
        let url_ = this.baseUrl + "/api/services/app/Autor/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
    ...
    protected processGet(response: HttpResponseBase): Observable<AutorDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getAll(keyword: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<AutorDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Autor/GetAll?";
        if (keyword === null)
            throw new Error("The parameter 'keyword' cannot be null.");
        else if (keyword !== undefined)
            url_ += "Keyword=" + encodeURIComponent("" + keyword) + "&";
    ...
    protected processGetAll(response: HttpResponseBase): Observable<AutorDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Autor/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
export class EmprestimoServiceProxy {
     ...
     * @return Success
     */
    getAllEmprestimosByUser(keyword: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined, pageNumber: number | undefined, pageSize: number | undefined): Observable<EmprestimoDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Emprestimo/GetAllEmprestimosByUser?";
        if (keyword === null)
            throw new Error("The parameter 'keyword' cannot be null.");
        else if (keyword !== undefined)
            url_ += "Keyword=" + encodeURIComponent("" + keyword) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllEmprestimosByUser(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllEmprestimosByUser(<any>response_);
                } catch (e) {
                    return <Observable<EmprestimoDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetAllEmprestimosByUser(response: HttpResponseBase): Observable<EmprestimoDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * @param idEmprestimo (optional) 
     * @return Success
     */
    devolverLivro(idEmprestimo: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Emprestimo/DevolverLivro?";
        if (idEmprestimo === null)
            throw new Error("The parameter 'idEmprestimo' cannot be null.");
        else if (idEmprestimo !== undefined)
            url_ += "idEmprestimo=" + encodeURIComponent("" + idEmprestimo) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDevolverLivro(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDevolverLivro(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processDevolverLivro(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    renovarEmprestimo(idEmprestimo: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Emprestimo/RenovarEmprestimo?";
        if (idEmprestimo === null)
            throw new Error("The parameter 'idEmprestimo' cannot be null.");
        else if (idEmprestimo !== undefined)
            url_ += "idEmprestimo=" + encodeURIComponent("" + idEmprestimo) + "&";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processRenovarEmprestimo(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processRenovarEmprestimo(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processRenovarEmprestimo(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class GeneroServiceProxy {
     ...
     * @return Success
     */
    create(body: CreateGeneroDto | undefined): Observable<GeneroDto> {
        let url_ = this.baseUrl + "/api/services/app/Genero/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<GeneroDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GeneroDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
     ...
     * @return Success
     */
    update(body: UpdateGeneroDto | undefined): Observable<GeneroDto> {
        let url_ = this.baseUrl + "/api/services/app/Genero/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<GeneroDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * @param idGenero (optional) 
     * @return Success
     */
    deActivate(idGenero: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Genero/DeActivate?";
        if (idGenero === null)
            throw new Error("The parameter 'idGenero' cannot be null.");
        else if (idGenero !== undefined)
            url_ += "idGenero=" + encodeURIComponent("" + idGenero) + "&";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getGenero(keyword: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined, pageNumber: number | undefined, pageSize: number | undefined): Observable<GeneroDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Genero/GetGenero?";
        if (keyword === null)
            throw new Error("The parameter 'keyword' cannot be null.");
        else if (keyword !== undefined)
            url_ += "Keyword=" + encodeURIComponent("" + keyword) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetGenero(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetGenero(<any>response_);
                } catch (e) {
                    return <Observable<GeneroDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<GeneroDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetGenero(response: HttpResponseBase): Observable<GeneroDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GeneroDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GeneroDtoPagedResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<GeneroDto> {
        let url_ = this.baseUrl + "/api/services/app/Genero/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
    ...
    protected processGet(response: HttpResponseBase): Observable<GeneroDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getAll(keyword: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<GeneroDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Genero/GetAll?";
        if (keyword === null)
            throw new Error("The parameter 'keyword' cannot be null.");
        else if (keyword !== undefined)
            url_ += "Keyword=" + encodeURIComponent("" + keyword) + "&";
    ...
    protected processGetAll(response: HttpResponseBase): Observable<GeneroDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class LivroServiceProxy {
     ...
     * @return Success
     */
    cadastrarQrCode(idLivro: number | undefined): Observable<string> {
        let url_ = this.baseUrl + "/api/services/app/Livro/CadastrarQrCode?";
        if (idLivro === null)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCadastrarQrCode(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCadastrarQrCode(<any>response_);
                } catch (e) {
    ...
    protected processCadastrarQrCode(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class UserServiceProxy {
    ...
    getUserLogado(): Observable<UserDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetUserLogado(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
...
export class AutorDto implements IAutorDto {
    ...
    static fromJS(data: any): AutorDto {
        data = typeof data === 'object' ? data : {};
        let result = new AutorDto();
        result.init(data);
        return result;
    }
...
export class AutorDtoPagedResultDto implements IAutorDtoPagedResultDto {
    items: AutorDto[] | undefined;
    totalCount: number;

    constructor(data?: IAutorDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items.push(AutorDto.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): AutorDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new AutorDtoPagedResultDto();
        result.init(data);
        return result;
    }
...
export interface IAutorDtoPagedResultDto {
    items: AutorDto[] | undefined;
    totalCount: number;
}
...
export class CreateAutorDto implements ICreateAutorDto {
    nome: string;

    constructor(data?: ICreateAutorDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateAutorDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateAutorDto();
        result.init(data);
        return result;
    }
...
export interface ICreateAutorDto {
    nome: string;
}
...
export class CreateGeneroDto implements ICreateGeneroDto {
    ...
    constructor(data?: ICreateGeneroDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateGeneroDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateGeneroDto();
        result.init(data);
        return result;
    }
...
export class GeneroDto implements IGeneroDto {
    ...
    static fromJS(data: any): GeneroDto {
        data = typeof data === 'object' ? data : {};
        let result = new GeneroDto();
        result.init(data);
        return result;
    }
...
export class GeneroDtoPagedResultDto implements IGeneroDtoPagedResultDto {
    items: GeneroDto[] | undefined;
    totalCount: number;

    constructor(data?: IGeneroDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items.push(GeneroDto.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): GeneroDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new GeneroDtoPagedResultDto();
        result.init(data);
        return result;
    }
...
export interface IGeneroDtoPagedResultDto {
    items: GeneroDto[] | undefined;
    totalCount: number;
}
...
export class UpdateAutorDto implements IUpdateAutorDto {
    id: number;
    nome: string;

    constructor(data?: IUpdateAutorDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateAutorDto {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateAutorDto();
        result.init(data);
        return result;
    }
...
export interface IUpdateAutorDto {
    id: number;
    nome: string;
}
...
export class UpdateGeneroDto implements IUpdateGeneroDto {
    ...
    constructor(data?: IUpdateGeneroDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateGeneroDto {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateGeneroDto();
        result.init(data);
        return result;
    }
